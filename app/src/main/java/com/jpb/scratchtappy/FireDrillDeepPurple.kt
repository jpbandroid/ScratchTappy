...
class FireDrillDeepPurple : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_deeppurple)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton4)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillIndigo::class.java)
