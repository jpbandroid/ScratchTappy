...
class FireDrillDeepOrange : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_deeporange)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton16)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillEnd::class.java)
