...
class FireDrillCyan : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_cyan)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton8)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillTeal::class.java)
