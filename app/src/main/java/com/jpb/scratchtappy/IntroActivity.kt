    ...
    private fun createOnboarderPages(): MutableList<OnboarderPage> {
        return mutableListOf(
            onboarderPage {
                ...
                description {
                    text = "This app helps you relieve stress with a blue Button (formerly a FloatingActionButton), and also appeals to people that want to test out all of the Material Design components, and people who want a simple, but elegant, calendar"
                    textColor = color(R.color.white)
            ...
            onboarderPage {
                ...
                description {
                    text = "ScratchTappy is also optimized for TVs!\nIt has a TV-friendly makeup in the majority, but unfortunately, some more recent UI surfaces (like tbe new Settings and the easter eggs) are not fit for TVs!"
                    textColor = color(R.color.black)
                    multilineCentered = true
                }
