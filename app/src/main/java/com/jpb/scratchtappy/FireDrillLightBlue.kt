...
class FireDrillLightBlue : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_light_blue)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton7)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillCyan::class.java)
