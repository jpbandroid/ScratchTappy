...
class FireDrillYellow : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_yellow)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton13)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillAmber::class.java)
