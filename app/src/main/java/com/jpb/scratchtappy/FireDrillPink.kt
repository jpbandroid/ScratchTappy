...
class FireDrillPink : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_pink)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton2)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillPurple::class.java)
