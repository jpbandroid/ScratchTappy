...
class FireDrillLightGreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_lightgreen)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton11)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillLime::class.java)
