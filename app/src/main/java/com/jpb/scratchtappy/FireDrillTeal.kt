...
class FireDrillTeal : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_teal)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton9)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillGreen::class.java)
