...
class FireDrillGreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_green)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton10)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillLightGreen::class.java)
