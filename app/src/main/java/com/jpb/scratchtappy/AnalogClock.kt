...
open class AnalogClock @JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(resolveSizeAndState((mDialWidth * scale).toInt(), widthMeasureSpec, 0),
    ...
    init {
        ...
        if (mDial == null) {
            mDial = context?.let { ContextCompat.getDrawable(it, R.drawable.clock_dial) }
            setDrawableTint(mDial as VectorDrawable?, "system_neutral1_200")
        }
        mHourHand = a?.getDrawable(R.styleable.AnalogClock_hand_hour)
        if (mHourHand == null) {
            mHourHand = context?.let { ContextCompat.getDrawable(it, R.drawable.clock_hand_hour) }
        ...
        if (mMinuteHand == null) {
            mMinuteHand = context?.let { ContextCompat.getDrawable(it, R.drawable.clock_hand_minute) }
