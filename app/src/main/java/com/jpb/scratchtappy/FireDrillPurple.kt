...
class FireDrillPurple : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_purple)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton3)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillDeepPurple::class.java)
