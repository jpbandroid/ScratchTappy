...
class FireDrillAmber : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_amber)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton14)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillOrange::class.java)
