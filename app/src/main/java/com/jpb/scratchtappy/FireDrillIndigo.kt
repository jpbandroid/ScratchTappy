...
class FireDrillIndigo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_indigo)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton5)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillBlue::class.java)
