...
class FireDrillLime : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_lime)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton12)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillYellow::class.java)
