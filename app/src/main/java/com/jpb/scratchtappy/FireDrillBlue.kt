...
class FireDrillBlue : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fire_drill_blue)
        val app6 = findViewById<FloatingActionButton>(R.id.floatingActionButton6)
        app6.setOnClickListener(View.OnClickListener { view: View? ->
            val intent = Intent(applicationContext, FireDrillLightBlue::class.java)
